...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build and serve the Samsung Electronics + SL demo.")
...
def _start_web() -> None:
    ...
    print("Two-stock demo: http://localhost:8000/demo/two-stocks")
    print("Samsung detail: http://localhost:8000/stock/005930")
    print("SL detail: http://localhost:8000/stock/005850")
